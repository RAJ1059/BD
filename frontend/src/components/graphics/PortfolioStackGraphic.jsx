...
const cards = [
  { title: 'Northstar Health', tag: 'SEO + Web', color: '#A050F8', rotate: -8, x: -60, y: -20, delay: 0 },
  { title: 'Aurelia Capital', tag: 'PPC + Analytics', color: '#FF7439', rotate: 4, x: 40, y: -50, delay: 0.15 },
  { title: 'Lumen Retail', tag: 'Ecommerce Growth', color: '#FF5C35', rotate: -4, x: 10, y: 40, delay: 0.3 },
]
    ...
    <div className="relative mx-auto flex h-[360px] w-full max-w-md items-center justify-center sm:h-[420px]">
      ...
      {cards.map((card, i) => (
        <motion.div
          ...
          className="absolute w-56 overflow-hidden rounded-2xl border border-white/10 bg-[#111115] shadow-xl"
          style={{ zIndex: cards.length - i }}
        >
          <div className="h-28 w-full" style={{ background: `linear-gradient(135deg, ${card.color}55, #09090B)` }} />
