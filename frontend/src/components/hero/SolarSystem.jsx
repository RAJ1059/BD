...
const planets = [
  { icon: FiSearch, label: 'SEO', radius: 88, size: 44, duration: 18, angle: 0, color: '#05B0BA' },
  { icon: FiTarget, label: 'PPC', radius: 128, size: 46, duration: 24, angle: 72, reverse: true, color: '#22D3D9' },
  { icon: FiZap, label: 'Social', radius: 168, size: 44, duration: 30, angle: 144, color: '#0891A0' },
  { icon: FiMonitor, label: 'Web', radius: 205, size: 48, duration: 36, angle: 216, reverse: true, color: '#05B0BA' },
  { icon: FiPenTool, label: 'Brand', radius: 238, size: 42, duration: 42, angle: 288, color: '#22D3D9' },
]
  ...
  return (
    <div className="relative mx-auto flex h-[440px] w-[440px] max-w-full items-center justify-center sm:h-[520px] sm:w-[520px]">
      ...
      <div className="relative z-10">
        <div
          className="flex h-24 w-24 items-center justify-center rounded-full border border-white/20 bg-gradient-to-br from-[#05B0BA] to-[#22D3D9] shadow-2xl sm:h-28 sm:w-28"
          ...
          <div key={planet.label} className="orbit-ring" style={{ '--orbit-size': `${size}px` }}>
            ...
            >
              <div className="orbit-anchor">
                ...
                >
                  <div
                    className="flex flex-col items-center gap-1.5 rounded-2xl border border-white/10 bg-[#141928]/90 px-3 py-2.5 backdrop-blur-md transition-transform duration-300 hover:scale-105"
